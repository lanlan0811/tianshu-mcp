...
through a private channel on the project repository (see the private reporting method in
[SECURITY.en.md](SECURITY.en.md)). All complaints will be reviewed and investigated promptly and fairly.

Maintainers are obligated to respect the privacy and security of the reporter of any incident.

## Enforcement Guidelines

Maintainers will follow these impact levels in determining consequences:

1. **Correction**: a private, written warning explaining the nature of the violation and why the behavior was inappropriate.
2. **Warning**: a warning with conditions, including no interaction with the people involved for a specified period.
3. **Temporary ban**: a temporary ban from any sort of interaction with the project for a specified period.
...
Chinese version: [CODE_OF_CONDUCT.md](CODE_OF_CONDUCT.md)
